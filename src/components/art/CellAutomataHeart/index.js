...
class CellAutomataHeart extends Component {
  constructor () {
    super();
  ...
  update(){
    ...
    while (cell != null) {
      ...
      cell.bufferR += cell.bufferRVel;
			...
			if (cell.bufferR < 0) {
				cell.bufferR = cell.bufferR + 200;
				cell.bufferRVel *= -1;
			} else if (cell.bufferR > 200) {
				cell.bufferR = cell.bufferR - 200;
				cell.bufferRVel *= -1;
			}
      cell = cell.next;
        ...
        style={
          {
            flexBase:2.6 + 'vw',
            height:2.6 + 'vw',
            transform: 'scale3d('+(cell.r / 185)+', '+(cell.r / 185) + ', 1)'
...
export default CellAutomataHeart
