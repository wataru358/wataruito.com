...
// idea was good
// I wanted rotatinon duration change...
// the thing is, I cannot change the animation duration during animation without resetting
// transition is the same.
// whenever you change, it resets...
    ...
    return (
      <div
        ...
        onAnimationEnd={(e) => {
            //console.log(e);
            e.persist();
            e.currentTarget.style.animationDuration = (e.currentTarget.dataset.nextDuration / 100) + 's';
